...
public class AbBottomTabView extends LinearLayout {
	...
	/** tab滑块颜色. */
	private int tabSlidingColor = tabBackgroundResource;
    ...
    public void setCurrentItem(int index) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (isSelected) { //选中状态下
            	...
            	if(tabItemDrawableList.size() >= tabCount*2){//1、3、5 图片  初始化
            	...
            	if(tabItemDrawableList.size() >= tabCount*2){//0,2,4 图片  初始化
    ...
    public void setTabLayoutBackground(int resid) {
        this.mTabLayout.setBackgroundColor(resid);
    }
     ...
     * @param size the size
     */
    public void setTabSlidingHeight(int size) {
        this.tabSlidingHeight = size;
    }
    ...
    public void setTabIndexItemDrawable(int index,Drawable drawable){
        tabItemDrawableList.set(index,drawable);
