 ...
 */
public class AbPullToRefreshViewTwo extends LinearLayout {
	...
	/** header view. */
	private AbListViewFooterTwo  mHeaderView;
	
	/** footer view. */
	private AbListViewHeaderTwo mFooterView;
	 ...
	 */
	public AbPullToRefreshViewTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	 ...
	 * @param context the context
	 */
	public AbPullToRefreshViewTwo(Context context) {
		super(context);
		init(context);
	}
	...
	private void addHeaderView() {
        mHeaderView = new AbListViewFooterTwo(mContext);
        mHeaderViewHeight = mHeaderView.getFooterHeight();
	...
	private void addFooterView() {
        ...
        mFooterView = new  AbListViewHeaderTwo(mContext);
        mFooterViewHeight= mFooterView.getHeaderHeight();
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderView.getState() != AbListViewHeaderTwo.STATE_REFRESHING) {
		    //提示松开刷新
		    mHeaderView.setState(AbListViewHeaderTwo.STATE_READY);
		
		} else if (newTopMargin < 0 && newTopMargin > -mHeaderViewHeight) {
		    //提示下拉刷新
		    mHeaderView.setState(AbListViewHeaderTwo.STATE_NORMAL);
		}
	}
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterView.getState()  != AbListViewFooterTwo.STATE_LOADING) {
			mFooterView.setState(AbListViewFooterTwo.STATE_READY);
		} else if (Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)) {
		    mFooterView.setState(AbListViewFooterTwo.STATE_LOADING);
		}
	}
	...
	public void headerRefreshing() {
		...
		mHeaderView.setState(AbListViewHeaderTwo.STATE_REFRESHING);
	...
	public void onHeaderRefreshFinish() {
		...
		if(mAdapterView!=null){
			...
			if(mCount > 0){
				...
				mFooterView.setState(AbListViewFooterTwo.STATE_EMPTY);
			}
		}else{
			mFooterView.setState(AbListViewFooterTwo.STATE_READY);
		}
	...
	public void onFooterLoadFinish() {
		...
		if(mAdapterView!=null){
			...
			if(countNew > mCount){
				...
				mFooterView.setState(AbListViewFooterTwo.STATE_NO);
			}
		}else{
			mFooterView.setState(AbListViewFooterTwo.STATE_READY);
		}
     ...
     */
    public  AbListViewFooterTwo getHeaderView() {
        return mHeaderView;
    }
     ...
     */
    public AbListViewHeaderTwo getFooterView() {
        return mFooterView;
    }
    ...
    public ProgressBar getHeaderProgressBar() {
        return mHeaderView. getFooterProgressBar();
    }
	...
	public interface OnFooterLoadListener {
		 ...
		 * @param view the view
		 */
		public void onFooterLoad(AbPullToRefreshViewTwo view);
	}
	...
	public interface OnHeaderRefreshListener {
		 ...
		 * @param view the view
		 */
		public void onHeaderRefresh(AbPullToRefreshViewTwo view);
	}
