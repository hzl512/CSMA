 ...
 */
public class AbListViewHeaderTwo extends LinearLayout {
	 ...
	 */
	public AbListViewHeaderTwo(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public AbListViewHeaderTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
