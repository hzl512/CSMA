 ...
 */
public class AbListViewFooterTwo extends LinearLayout {
	 ...
	 */
	public AbListViewFooterTwo(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public AbListViewFooterTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
