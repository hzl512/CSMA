...
import com.weicent.android.csma.adapter.result.ProfessionAdapter;
...
import com.weicent.android.csma.data.result.list.ResProfessionList;
...
public class ProfessionListActivity extends AbActivity implements IBinDing, AbPullToRefreshView.OnHeaderRefreshListener
    ...
    private ProfessionAdapter adapter = null;//数据适配器
    ...
    public void initView() {
        departments = getIntent().getParcelableExtra(App.MODEL_NAME);
        abTitleBar = this.getTitleBar();
        abTitleBar.setTitleText(departments.departmentsName + "专业列表");
        ...
        adapter = new ProfessionAdapter(this, null);
    ...
    public void onHeaderRefresh(AbPullToRefreshView view) {
        NetWorkWeb.getInstance().doRequest(Global.URL_PROFESSION_SERVLET, new ResultHandlerForJson<ResProfessionList>(ResProfessionList.class) {
            ...
            public void onFailure(int statusCode, Header[] headers, String resultString, Throwable throwable) {
                if (adapter.isEmpty()) {
                    ...
                    T.showShort(ProfessionListActivity.this, App.NET_OUT_MSG);
                }
            }
        ...
        }, "{\"paging\":true,\"page_no\":1,\"page_size\":" + pageSize + ",\"departmentsID\":" + departments.id + "}", 5);
    }
    ...
    public void onFooterLoad(AbPullToRefreshView view) {
        if (adapter.getCount() >= total) {
            ...
            T.showShort(ProfessionListActivity.this, App.NOT_DATA_MSG);
        } else {
            currentPage++;
            NetWorkWeb.getInstance().doRequest(Global.URL_PROFESSION_SERVLET, new ResultHandlerForJson<ResProfessionList>(ResProfessionList.class) {
            ...
            }, "{\"paging\":true,\"page_no\":" + currentPage + ",\"page_size\":" + pageSize + ",\"departmentsID\":" + departments.id + "}", 5);
        }
    }
